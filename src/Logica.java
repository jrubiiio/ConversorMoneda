...
//Estructura para la información de las monedas a convertir
public class Logica {
    ...
    public Logica(ConsultaAPI conversion) {
    ...
    public void almacenarValores(String monedaInicial, String monedaFinal){
        ...
        System.out.println("¿Qué valor deseas convertir?");
    ...
    public void almacenarValoresPersonalizados(){
        String OtrasOpciones = """
                ...
                """;
        System.out.println(OtrasOpciones);
        System.out.println("Ingrese la clave de la moneda inicial (Currency code)");
        this.monedaInicial = lectura.next();
        System.out.println("Ingrese la clave de la moneda final (Currency code)");
    ...
    public String obtenerMensajeRespuesta() {
        String mensaje = getMonedaInicial().toUpperCase() + " " + getCantidad() + " es igual a: " + getMonedaFinal().toUpperCase() + " " + conversion.buscaConversion(getMonedaInicial(), getMonedaFinal(), getCantidad());
